...
<body>
    ...
    <section class="tm-imgslider">
        ...
        <div class="slider single">
            <div>
                <div class="tm-slider"><img class="tm-sliderimage" src="images/main_slider11.png" alt="Majestic Hotel">
                    <div class="tm-slidertext">
                        <p class="bold"> Expeirence</p>
                        <p class="simple">The Beauty and ambience </p>
                        <p class="simple">All in one  </p>
                    </div>
                </div>
            </div>
            <div>
            ...
            <div>
                <div class="tm-slider"><img class="tm-sliderimage" src="images/main_slider14.png" alt="Majestic Hotel">
                    <div class="tm-slidertext">
    ...
    <section class="tm-servicesection">
        <div class="tm-service">
            ...
            <div>
                ...
                <p> Enjoy your stay with extremely and timely room service </p>
            </div>
        </div>
        <div class="tm-service">
        ...
        <div class="tm-review ">
            <div class="slider review">
                <div class="tm-revcon">
                    ...
                    <div class="tm-rev">
                        <p> Great hotel, I am recommending it to everyone. Wished i had stayed few more days there.</p>
                        <br />
